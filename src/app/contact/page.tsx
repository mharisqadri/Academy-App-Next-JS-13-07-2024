    ...
    <div className="h-[40rem] w-full rounded-md bg-neutral-950 relative flex flex-col items-center justify-center antialiased">
      <div className="max-w-2xl mx-auto p-4">
        ...
        <input
          ...
          className="rounded-md border text-white border-neutral-800 focus:ring-2 focus:ring-teal-500 w-[600px] p-3 h-10 relative z-10 mt-4  bg-neutral-950 placeholder:text-neutral-600"
        />
        <input
          type="text"
          ...
          className="rounded-md border text-white border-neutral-800 focus:ring-2 focus:ring-teal-500 w-[600px] p-3 h-10 relative z-10 mt-4  bg-neutral-950 placeholder:text-neutral-600"
        />
        <textarea className="rounded-md border border-neutral-800 focus:ring-2 focus:ring-teal-500  w-[600px] p-3 relative z-10 mt-5 h-[200px] text-white bg-neutral-950 placeholder:text-neutral-600
